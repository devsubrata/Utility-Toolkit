...
(function (g, f) {
    ...
    var ye = (l, e) => {
        ...
        Re = (l, e, t, n) => {
            if ((e && typeof e == "object") || typeof e == "function")
                for (let s of Te(e)) !we.call(l, s) && s !== t && H(l, s, { get: () => e[s], enumerable: !(n = be(e, s)) || n.enumerable });
            return l;
        };
    ...
    var m = {
        ...
        j = {
            ...
            emStrongLDelim: Fe,
            url: h(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, "i")
    ...
    function me(l, e, t, n, s) {
        ...
        n.state.inLink = !0;
        let a = { type: l[0].charAt(0) === "!" ? "image" : "link", raw: t, href: i, title: r, text: o, tokens: n.inlineTokens(o) };
...
`,
                            ...
                            .replace(this.rules.other.listReplaceTabs, (Z) => " ".repeat(3 * Z.length)),
                        g = e.split(
                            `
`,
                            1
                    ...
                    if (
                        (this.options.pedantic
                            ...
                            : T
                            ? (f = t[1].length + 1)
                            : ((f = t[2].search(this.rules.other.nonSpaceChar)), (f = f > 4 ? 1 : f), (u = d.slice(f)), (f += t[1].length)),
                        T &&
...
`,
                            ...
                            if (
                                ...
                                ne.test(g) || se.test(g) || xe.test(g) || Z.test(g) || te.test(g))
                            )
                                break;
...
`),
                    ...
                    this.options.gfm &&
                        ...
                        y && ((ee = y[0] !== "[ ] "), (u = u.replace(this.rules.other.listReplaceTask, "")))),
                        i.items.push({ type: "list_item", raw: p, task: !!y, checked: ee, loose: !1, text: u, tokens: [] }),
                        (i.raw += p);
                }
                let a = i.items.at(-1);
            ...
            if (n.length === s.length) {
                for (let o of s)
                    this.rules.other.tableAlignRight.test(o)
                        ...
                        ? r.align.push("left")
                        : r.align.push(null);
                for (let o = 0; o < n.length; o++) r.header.push({ text: n[o], tokens: this.lexer.inline(n[o]), header: !0, align: r.align[o] });
                for (let o of i)
            ...
            if (t) {
                ...
                return (
                    ...
                    this.rules.other.startAngleBracket.test(s) &&
                        (this.options.pedantic && !this.rules.other.endAngleBracket.test(n) ? (s = s.slice(1)) : (s = s.slice(1, -1))),
                    me(
                        t,
                        {
    ...
    var x = class l {
        ...
        constructor(e) {
            ...
            this.options.pedantic
                ...
                : this.options.gfm && ((t.block = B.gfm), this.options.breaks ? (t.inline = P.breaks) : (t.inline = P.gfm)),
            ...
            for (this.options.pedantic && (e = e.replace(m.tabCharGlobal, "    ").replace(m.spaceLine, "")); e; ) {
                ...
                if (
                    this.options.extensions?.block?.some((r) =>
                        (s = r.call({ lexer: this }, e, t)) ? ((e = e.substring(s.raw.length)), t.push(s), !0) : !1
                    )
                )
                    continue;
...
` + s.raw),
                          (this.inlineQueue.at(-1).src = r.text))
                        : this.tokens.links[s.tag] || (this.tokens.links[s.tag] = { href: s.href, title: s.title });
                    continue;
                }
                ...
                if (this.options.extensions?.startBlock) {
                    ...
                    this.options.extensions.startBlock.forEach((c) => {
                        (a = c.call({ lexer: this }, o)), typeof a == "number" && a >= 0 && (r = Math.min(r, a));
                    }),
            ...
            for (; e; ) {
                ...
                if (
                    this.options.extensions?.inline?.some((c) =>
                        (o = c.call({ lexer: this }, e, t)) ? ((e = e.substring(o.raw.length)), t.push(o), !0) : !1
                    )
                )
                    continue;
                    ...
                    ? e.tokens[0]?.type === "paragraph"
                        ? ((e.tokens[0].text = n + " " + e.tokens[0].text),
                          e.tokens[0].tokens &&
                              ...
                              ((e.tokens[0].tokens[0].text = n + " " + R(e.tokens[0].tokens[0].text)), (e.tokens[0].tokens[0].escaped = !0)))
        ...
        parse(e, t = !0) {
            ...
            for (let s = 0; s < e.length; s++) {
                ...
                if (this.options.extensions?.renderers?.[i.type]) {
                    let o = i,
                        a = this.options.extensions.renderers[o.type].call({ parser: this }, o);
                    if (
                        a !== !1 ||
                        !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(o.type)
                    ) {
                        n += a || "";
                        continue;
                    }
            ...
            return (n, s) => {
                ...
                if (r.async)
                    return Promise.resolve(r.hooks ? r.hooks.preprocess(n) : n)
                        ...
                        .then((p) => (r.walkTokens ? Promise.all(this.walkTokens(p, r.walkTokens)).then(() => p) : p))
                        .then((p) => c(p, r))
